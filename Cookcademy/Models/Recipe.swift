...
struct Recipe: Identifiable {
    ...
    // Initialising empty recipe user can edit
...
struct MainInformation {
    ...
    // enum contianing all the values category could be
...
// Key info about each direction
struct Direction {
    var description: String
    var isOptional: Bool
}

// Key info about each ingredient
struct Ingredient {
    var name: String
    var quantity: Double
    var unit: Unit // ounces, hrams, cups, tablespoons, teaspoons, none
        
    // formatted description of ingredient
    var description: String {
    ...
    // enum containing all values a unit could be
    enum Unit: String, CaseIterable {
        ...
        // prints singular ingredient e.g. 1 cup with no s
        var singularName: String { String(rawValue.dropLast()) }
    }
}

// Recipes from codecademy
extension Recipe {
